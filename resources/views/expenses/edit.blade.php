...
<div class="max-w-2xl mx-auto bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Expense</h2>
    ...
    <form action="{{ route('expenses.update', $expense->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="description" id="description" value="{{ $expense->description }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <input type="date" name="date" id="date" value="{{ $expense->date->format('Y-m-d') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
            </div>
        </div>
